...
- Folder: `.squad/stories/checkout/customer-management/intake.md`
...
```
- Customer profiles: each customer should has it's own profile.
- Contact details: each customer should has contact details like phone, email,...etc
- Interaction history
- Notes and attachments
```
